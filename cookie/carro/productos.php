    ...
    try {
        ...
        <html>
            <head>
                ...
                <link rel="stylesheet" type="text/css" href="tienda.css" media="screen" />
            </head>
                ...
                <div id="contenedor">
                    ...
                    <div id="cesta">
                        ...
                        if (isset($_POST['enviar'])) {
                            ...
                            $datos = array('nombre' => $_POST['nombre'], 'precio' => $_POST['precio'], 'cantidad' => $cantidad, 'codigo' => $_POST['enviar']);
